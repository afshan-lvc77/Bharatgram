...
// Page load hote hi feed chalao ya login par bhejo
auth.onAuthStateChanged((user) => {
    if (user) {
        // Agar user login hai toh feed dikhao
        loadFeed();
    } else {
        // Agar user login NAHI hai, toh signup page par bhejo
        // Check kar lena ki path sahi hai (e.g., "pages/signup.html")
